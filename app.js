...
app.get("/search", async (req, res) => {
  try {
    ...
    if (!searchValue) {
      return res.render("listings/result", {
        query: "",
        results: [],
      });
    }
    searchValue = String(searchValue).trim(); // Ensure searchValue is a trimmed string
    ...
    res.render("listings/result", { query: searchValue, results: result });
  } catch (error) {
